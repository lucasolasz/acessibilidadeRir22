<div class="mx-auto p-2 mb-3 mt-3">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <form name="editar" method="POST" action="<?= URL . '/PlataformasController/editarPlataformaMundo/' ?>">
...
<script>
    ...
    function countChecked() {
        ...
        var limiteReservas = <?= $dados['contagemMarcacoesMundo'] ?>
